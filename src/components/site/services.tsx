...
const SERVICES: Service[] = [
  {
    ...
    flipImage: "/images/desarrolloweb.webp",
    flipDirection: "left",
    accent: "emerald",
    span: "lg:col-span-7",
  },
  {
    ...
    flipImage: "/images/webdeTurismo.webp",
    flipDirection: "up",
    accent: "amber",
    span: "lg:col-span-5",
  },
  {
    ...
    flipImage: "/images/Automatizaciones.webp",
    flipDirection: "down",
    accent: "amber",
    span: "lg:col-span-5",
  },
  {
    ...
    flipImage: "/images/marketing-flip.png",
    flipDirection: "right",
    accent: "emerald",
    span: "lg:col-span-7",
  },
...
function ServiceCard({ service: s }: { service: Service }) {
  ...
  return (
    <motion.article
      ...
      className={cn(
        "group relative min-h-[20rem] [perspective:1000px]",
        s.span
      )}
    >
      <div 
      ...
      >
        {/* FRONT FACE */}
        <div className="relative flex h-full w-full flex-col overflow-hidden rounded-3xl border border-border/60 p-6 sm:p-8 [backface-visibility:hidden] transition-all duration-500 group-hover:border-foreground/20 group-hover:shadow-[0_30px_80px_-30px_rgba(0,0,0,0.7)] bg-background">
        ...
        {s.flipImage && (
          <div className={cn(
            "absolute inset-0 h-full w-full rounded-3xl border border-border/60 overflow-hidden [backface-visibility:hidden] bg-background",
            backfaceTransformClasses[direction]
          )}>
            <img 
              src={s.flipImage} 
              alt="Reverso" 
